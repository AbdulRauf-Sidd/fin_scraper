...
async def extract_events_from_page(page):
    """Extracts event names, dates, and links from the paginated event list."""
    ...
    try:
        ...
        for event in event_items:
            try:
                ...
                base_url = "https://example.com"  # Change this to the actual base domain
                ...
                print(f"✅ Extracted event: {event_name}, Date: {event_date_parsed}, URL: {full_event_url}")
