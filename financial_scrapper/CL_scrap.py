...
# Configurations
SEC_FILINGS_URL = "https://investor.colgatepalmolive.com/sec-filings"
JSON_FILENAME = "colgate_sec_filings.json"
VALID_YEARS = {str(year) for year in range(2019, 2026)}  # 2019-2025
EQUITY_TICKER = "CL"  # Dynamically changeable
...
async def extract_files_from_page(page):
    ...
    try:
        ...
        # Get table headers to find correct column index
        ...
        for row in rows:
            ...
            try:
                ...
                filing_year = int(filing_date.split()[-1])
                ...
                for link in view_column:
                    ...
                    if file_url and (file_url.endswith(".pdf") or "pdf" in file_text):
                        ...
                        file_links.append({
                            ...
                            "file_type": "pdf",
                            "date": datetime.strptime(filing_date, "%b %d, %Y").strftime("%Y/%m/%d"),
                            "category": "report",
                            "source_url": full_url,
                            "wissen_url": "unknown"
                        })
                ...
                if file_links:
                    file_links_collected.append({
                        ...
                        "event_date": datetime.strptime(filing_date, "%b %d, %Y").strftime("%Y/%m/%d"),
                        "data": file_links
                    })
