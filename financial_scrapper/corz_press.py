...
def classify_event(event_name, event_url, file_name, file_url):
    ...
    if re.search(periodic_keywords, event_name, re.IGNORECASE) or re.search(periodic_keywords, file_name, re.IGNORECASE) or re.search(periodic_keywords, event_url, re.IGNORECASE) or re.search(periodic_keywords, file_url, re.IGNORECASE):
        return "periodic"
    else:
        return "non-periodic"
...
async def extract_files_from_page(page):
    ...
    try:
        ...
        for date_element, media_link in zip(date_elements, media_links):
            ...
            freq = classify_event(event_name, event_url, event_name, event_url)
