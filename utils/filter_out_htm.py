...
file_paths = [
    ...
    'Completed/JSONS/CORZ_press.json',
    ...
    'Completed/JSONS/KER_finance.json',
    'Completed/JSONS/KER_annual_general_meeting.json',
    ...
    'Completed/JSONS/RKT_news.json',
    'Completed/JSONS/OR_news.json',
    'Completed/JSONS/OR_half.json',
    'Completed/JSONS/OR_annual.json',
    ...
    'Completed/JSONS/BAS_publications.json',
    'Completed/JSONS/BAS_news.json',
