...
CONTENT_PATTERNS: Dict[str, List[str]] = {
    ...
    r"\b10-k\b":                       ["10-K", "sec_filing"],
    r"\b10-q\b":                       ["10-Q", "sec_filing"],
    r"\bannual\s+report\b":            ["annual_report"],
    r"\bsec\s+filings?\b":             ["sec_filing"],
    r"\bfinancials?\b":                ["financial_filing"],
    r"\breports?\b":                   ["financial_filing"],
    r"\bearnings\s+release\b":         ["financial_filing"],
    ...
    r"\bsellside\s+conference\b":      ["sellside_conference"],
    r"\bindustry\s+conference\b":      ["industry_conference"],
    r"\binvestor\s+day\s+presentation\b": ["investor_day_presentation"],
    r"\bpreliminary\s+results?\b":     ["preliminary-results"],
    r"\binterim\s+results?\b":         ["interim-results"],
    r"\btrading\s+update\b":           ["trading-update"],
    r"\bfull[-\s]year\s+results?\b":   ["full-year-results"],
    r"\bnine[-\s]month\s+sales?\b":    ["nine-month-sales"],
    r"\bhalf[-\s]year\s+results?\b":   ["half-year-results"],
    r"\bthree[-\s]month\s+results?\b": ["three-month-results"],
    r"\bannual[-\s]+general[-\s]+meeting\b": ["annual-general-meeting"],
    r"\bagm\b":                        ["annual-general-meeting"],
    r"\bq[1-4]\s?\d{4}\b":             ["three-month-results"],  
}
